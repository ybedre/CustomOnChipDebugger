...
namespace CustomOnChipDebuggerConsoleApp
{
    public class GDBSession
    {
        ...
        public static Dictionary<string, uint> ParseSFileForRegisters()
        {
            ...
            var filePath = @"C:\Users\yasha.LAPTOP-L0KCDRSD\OneDrive\TUHH\WiSe2022\ProjectArbeit\CustomOCD\CustomOnChipDebugger\Binaries\Hello.s";
        ...
        {
            uint pc = 10000;
            string filePath = @"C:\Users\yasha.LAPTOP-L0KCDRSD\OneDrive\TUHH\WiSe2022\ProjectArbeit\CustomOCD\CustomOnChipDebugger\Binaries\Hello.s";
